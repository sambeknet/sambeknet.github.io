...
document.addEventListener('mouseover', (e) => {
    if (e.target.closest('.interactable, .nav-placeholder')) {
        cursorEl.style.backgroundImage = "url('../assets/images/cursor2.png')";
    } else {
        cursorEl.style.backgroundImage = "url('../assets/images/cursor1.png')";
    }
});
...
document.getElementById("shop-toggle-btn").addEventListener("click", () => {
    ...
    if (isSkinsMenu) {
        ...
        document.getElementById("shop-toggle-img").src = "../assets/images/shop.png";
        ...
        document.getElementById("shop-toggle-img").src = "../assets/images/boat1.png";
...
function generateSeabed() {
    ...
    let items = ["../assets/images/seaweed1.png", "../assets/images/seaweed2.png", "../assets/images/coral.png"];
...
setInterval(function spawnSeagull() {
    ...
    gull.src = "../assets/images/seagull.png";
...
function spawnFish(lineIndex) {
    ...
    let type = "normal";
    let imgSrc = `../assets/images/fish${lineIndex + 1}.png`; 
    let baseValue = fishValues[lineIndex];
    let finalValue = baseValue;

    if (Math.random() < 1/20) {
        type = "trash"; imgSrc = "../assets/images/trash.png";
    } else if (Math.random() < 1/50) {
        type = "special"; imgSrc = "../assets/images/special.png";
    } else {
        if (goldenModeTimer > 0 || Math.random() < (1 / goldenChances[goldenLvl - 1])) {
            type = "golden"; imgSrc = "../assets/images/golden.png"; finalValue = baseValue * 4;
        }
    }
                ...
                if (type === "special") {
                    ...
                    allFish.forEach(fishDiv => {
                        if (fishDiv.getAttribute("data-type") === "normal") {
                            ...
                            fishDiv.querySelector("img").src = "../assets/images/golden.png";
                        }
                    });
                } else {
                    playSound('reel');
